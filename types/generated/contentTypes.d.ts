...
export interface ApiAtricleAtricle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::atricle.atricle', 'Title'> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
